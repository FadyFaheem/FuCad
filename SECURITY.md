...
If the vulnerability also affects upstream FreeCAD, please report it to the
[FreeCAD project](https://github.com/FreeCAD/FreeCAD/security/advisories/new) as well so the fix benefits both
projects.
