...
${LangFileString} TEXT_WELCOME "Este assistente de instalação irá guiá-lo através da instalação do FuCad.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} TEXT_FINISH_WEBSITE "Visite fucad.org para as últimas notícias, suporte e dicas"
...
#${LangFileString} SecAllUsersDescription "Instalar o FuCad para todos os utilizadores ou apenas para o presente utilizador."
${LangFileString} SecFileAssocDescription "Os ficheiros com a extensão .FCStd irão abrir automaticamente no FuCad."
${LangFileString} SecDesktopDescription "Um icone do FuCad no ambiente de trabalho."
...
#${LangFileString} ConfigInfo "A configuração seguinte do FuCad irá demorar um bocado."
...
${LangFileString} AlreadyInstalled "O FuCad ${APP_SERIES_KEY2} já está instalado!$\r$\n\
				Quer continuar na mesma a instalar o FuCad sobre a versão existente?"
${LangFileString} NewerInstalled "Está a tentar instalar uma versão mais antiga do que a que tem instalada.$\r$\n\
				  Se realmente quer fazer isto deve antes desinstalar o FuCad $OldVersionNumber."
...
${LangFileString} FinishPageRun "Lançar o FuCad"

${LangFileString} UnNotInRegistryLabel "Incapaz de encontrar o FuCad no registry.$\r$\n\
					Os atalhos para o ambiente de trabalho no menu Start não serão removidos."
${LangFileString} UnInstallRunning "Deve fechar o FuCad em primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de privilégios de administrador para desinstalar o FuCad!"
${LangFileString} UnReallyRemoveLabel "Tem a certeza que quer remover completamente o FuCad e todas as suas componentes?"
${LangFileString} UnFuCadPreferencesTitle 'Preferências de utilizador do FuCad'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Apaga as pastas de configuração do  FuCad$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala FuCad e todas as suas componentes."
